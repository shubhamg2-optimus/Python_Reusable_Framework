...
class BaseScreen():
    ...
    def get_attribute(self, attribute, element_xpath=None, element_id=None):
        self.saveto.logger.info("Getting attribute value")
        if element_xpath != None:
            return self.driver.find_element_by_xpath(element_xpath).get_attribute(attribute)
        elif element_id != None:
            return self.driver.find_element_by_id(element_id).get_attribute(attribute)

    def get_value_of_css_property_by_xpath(self, element_xpath, property):
    ...
    def get_value_of_css_property_by_class(self, element_class, property):
        self.saveto.logger.info("Getting value of css property")
        return self.driver.find_element_by_class_name(element_class).value_of_css_property(property)
