from tests_web.base_test import BaseTest
...
class TestAccountDetails(BaseTest):
    ...
    def test_005_signup_with_valid_credentials(self):
        self.driver.get(self.url)
        self.hp.navigate_to_sign_up_page()
        self.sip.create_a_new_account()
        self.assertEqual(self.ch.random_username, self.hp.get_username(), "Incorrect Username")
        self.hp.log_out_account()